...
const ABOUT_TEXT =
  "I am a final-year B.Tech Computer Science student with a strong passion for Artificial Intelligence, Full-Stack Development, and modern software engineering. I enjoy designing and building scalable, high-performance applications that solve real-world problems through innovative technology. My experience spans developing full-stack web applications, AI-powered solutions, ERP systems, GIS-based analytical platforms, and cloud-deployed projects using technologies such as React.js, Node.js, .NET, Python, SQL, and modern development tools. I am committed to writing clean, efficient, and maintainable code while continuously expanding my knowledge of emerging technologies. As an aspiring AI Engineer and Software Developer, I am actively seeking opportunities to contribute to impactful projects, collaborate with talented teams, and build intelligent software solutions that create meaningful value.";
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          {
                            label: 'Languages',
                            items: ['Python', 'JavaScript', 'HTML', 'SQL'],
                          },
                          {
                            label: 'Frameworks & Libraries',
                            items: ['React', 'Pandas', 'NumPy'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['Figma', 'Vercel', 'Git', 'GitHub', 'Canva', 'Excel'],
                          },
                          {
                            label: 'AI & GenAI',
