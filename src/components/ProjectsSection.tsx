...
const PROJECTS: ProjectData[] = [
    {
        number: '01',
        category: 'Minor Project · Design',
        name: 'Flood Risk Identification System - India',
        liveUrl: 'https://flood-risk-mapping.vercel.app/',
        col1Image1: '/flood.png',
        col1Image2: '/flood1.png',
        col2Image: '/flood2.png',
      },
  {
      number: '02',
      category: 'Mini Project · Design',
      name: 'Smart Cyber Cafe Management & Billing Automation Platform',
      liveUrl: '',
      col1Image1: '/cafe.png',
      col1Image2: '/cafe1.png',
      col2Image: '/cafe2.png',
    },
  /*
  {
